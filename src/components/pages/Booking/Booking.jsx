...
const Booking = () => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center md:px-20">
            ...
            <div className="shadow-lg p-10 rounded-lg">
                <div className="card-body">
                    ...
                    <div className="form-control">
                        ...
                        <input type="text" placeholder="Please choose your city" className="input input-bordered w-full" />
                    </div>
                    ...
                    <div className="md:flex gap-6">
                        ...
                        <div className="form-control">
                            ...
                            <div className="md:flex  h-12  bg-[#F3F3F3] gap-8 items-center rounded-lg shadow-xl ">
                                <button className="bg-[#f7dada] rounded h-full w-10 flex justify-center items-center ">
